...
export default function MyOrderPage() {
  ...
  const tabs = [
    { key: "all", label: t("orders") }, // "Đơn hàng của tui"
    { key: "processing", label: t("ordersProcessing") },
    { key: "delivered", label: t("ordersDelivered") },
    { key: "canceled", label: t("ordersCanceled") },
  ];

  // Placeholder for orders (empty state as per the image)
  const orders = [];
    ...
    <div className={styles.mainContent}>
      ...
      {orders.length === 0 ? (
        <div className={styles.emptyState}>
          <Image
            src="/empty-orders.png" // Placeholder path; replace with actual image path
            alt="Empty Orders"
            width={120}
            height={120}
