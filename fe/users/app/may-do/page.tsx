...
import { FaHeart, FaWhatsapp, FaInstagram, FaQuestionCircle } from "react-icons/fa";
        ...
        <div className={styles.centeredContainer}>
          ...
          <div className={styles.order}>
            <div className={styles.orderHeader}>
              <p>Đơn hàng #24DH00016: Đã nhận đơn hàng</p>
              <p>30/04/2024</p>
            </div>
            <div className={styles.orderDetails}>
              <img
                src="/images/suit.jpg"
                alt="Bộ Vest Lanh 100% Màu Olive Cắt Slim"
                className={styles.orderImage}
              />
              <div className={styles.orderInfo}>
                <h3>Bộ Vest Lanh 100% Màu Olive Cắt Slim</h3>
                <p>Chất liệu: Xanh Olive | Kích thước: May theo số đo | Số lượng: 1</p>
                <div className={styles.orderActions}>
                  <button className={styles.favoriteButton}>
                    <FaHeart /> Yêu thích
                  </button>
                  <span className={styles.express}>Giao nhanh</span>
                </div>
              </div>
            </div>
            <button className={styles.measurementButton}>
              Cung cấp thông tin số đo
            </button>
          </div>
