...
import { getTranslations } from "next-intl/server"; // Xóa import getMessages
...
import { Messages } from "next-intl"; // Import kiểu Messages từ next-intl
import FloatingIcons from "../components/FloatingIcons"; // Thêm import FloatingIcons;
...
export default async function ShopPageClient({
  ...
  messages: Messages; // Sử dụng kiểu Messages thay vì Record<string, any>
}) {
  ...
  const categories: { name: string; slug: keyof typeof products }[] = [
